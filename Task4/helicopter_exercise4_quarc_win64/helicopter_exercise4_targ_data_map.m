  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (helicopter_exercise4_P)
    ;%
      section.nData     = 10;
      section.data(10)  = dumData; %prealloc
      
	  ;% helicopter_exercise4_P.K
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_P.K_ed
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 12;
	
	  ;% helicopter_exercise4_P.K_ei
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 13;
	
	  ;% helicopter_exercise4_P.K_ep
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 14;
	
	  ;% helicopter_exercise4_P.K_pd
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 15;
	
	  ;% helicopter_exercise4_P.K_pp
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 16;
	
	  ;% helicopter_exercise4_P.Vd_ff
	  ...
	  ;% helicopter_exercise4_P.elevation_gain
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 19;
	
	  ;% helicopter_exercise4_P.travel_gain
	  ...
	  ;% helicopter_exercise4_P.HILWriteAnalog_channels
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_OOTerminate
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_P.HILInitialize_OOExit
	  section.data(2).logicalSrcIdx = 12;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_exercise4_P.HILInitialize_OOStart
	  section.data(3).logicalSrcIdx = 13;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_exercise4_P.HILInitialize_OOEnter
	  section.data(4).logicalSrcIdx = 14;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOFinal
	  section.data(5).logicalSrcIdx = 15;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_exercise4_P.HILInitialize_POFinal
	  section.data(6).logicalSrcIdx = 16;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_exercise4_P.HILInitialize_AIHigh
	  section.data(7).logicalSrcIdx = 17;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_exercise4_P.HILInitialize_AILow
	  section.data(8).logicalSrcIdx = 18;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOHigh
	  section.data(9).logicalSrcIdx = 19;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOLow
	  section.data(10).logicalSrcIdx = 20;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOInitial
	  section.data(11).logicalSrcIdx = 21;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOWatchdog
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_POLeading
	  section.data(14).logicalSrcIdx = 24;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_exercise4_P.HILInitialize_POTrailing
	  section.data(15).logicalSrcIdx = 25;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_exercise4_P.HILInitialize_POInitial
	  section.data(16).logicalSrcIdx = 26;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_exercise4_P.HILInitialize_POWatchdog
	  ...
	  ;% helicopter_exercise4_P.Gain1_Gain
	  section.data(19).logicalSrcIdx = 29;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_exercise4_P.travel_offsetdeg_Value
	  ...
	  ;% helicopter_exercise4_P.Gain_Gain
	  ...
	  ;% helicopter_exercise4_P.TravelTransferFcn_C
	  ...
	  ;% helicopter_exercise4_P.Gain_Gain_a
	  section.data(28).logicalSrcIdx = 38;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helicopter_exercise4_P.PitchTransferFcn_A
	  section.data(29).logicalSrcIdx = 39;
	  section.data(29).dtTransOffset = 28;
	
	  ;% helicopter_exercise4_P.PitchTransferFcn_C
	  ...
	  ;% helicopter_exercise4_P.Gain_Gain_lv
	  ...
	  ;% helicopter_exercise4_P.Gain1_Gain_f
	  ...
	  ;% helicopter_exercise4_P.Gain_Gain_a1
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_CKChannels
	  section.data(1).logicalSrcIdx = 62;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOWatchdog
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_POModes
	  ...
	  ;% helicopter_exercise4_P.HILReadEncoderTimebase_Clock
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_AIChannels
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_EIChannels
	  ...
	  ;% helicopter_exercise4_P.HILReadEncoderTimebase_Channels
	  ...
	  ;% helicopter_exercise4_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 77;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOTerminate
	  section.data(2).logicalSrcIdx = 78;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOExit
	  section.data(3).logicalSrcIdx = 79;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOTerminate
	  section.data(4).logicalSrcIdx = 80;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOExit
	  section.data(5).logicalSrcIdx = 81;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_exercise4_P.HILInitialize_POTerminate
	  section.data(6).logicalSrcIdx = 82;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_exercise4_P.HILInitialize_POExit
	  section.data(7).logicalSrcIdx = 83;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_exercise4_P.HILInitialize_CKPStart
	  section.data(8).logicalSrcIdx = 84;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_exercise4_P.HILInitialize_CKPEnter
	  section.data(9).logicalSrcIdx = 85;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_exercise4_P.HILInitialize_CKStart
	  section.data(10).logicalSrcIdx = 86;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_exercise4_P.HILInitialize_CKEnter
	  section.data(11).logicalSrcIdx = 87;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_exercise4_P.HILInitialize_AIPStart
	  section.data(12).logicalSrcIdx = 88;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_exercise4_P.HILInitialize_AIPEnter
	  section.data(13).logicalSrcIdx = 89;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOPStart
	  section.data(14).logicalSrcIdx = 90;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOPEnter
	  section.data(15).logicalSrcIdx = 91;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOStart
	  section.data(16).logicalSrcIdx = 92;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOEnter
	  section.data(17).logicalSrcIdx = 93;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_exercise4_P.HILInitialize_AOReset
	  section.data(18).logicalSrcIdx = 94;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOPStart
	  section.data(19).logicalSrcIdx = 95;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOPEnter
	  section.data(20).logicalSrcIdx = 96;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOStart
	  section.data(21).logicalSrcIdx = 97;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOEnter
	  section.data(22).logicalSrcIdx = 98;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOReset
	  section.data(23).logicalSrcIdx = 99;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helicopter_exercise4_P.HILInitialize_EIPStart
	  section.data(24).logicalSrcIdx = 100;
	  section.data(24).dtTransOffset = 23;
	
	  ;% helicopter_exercise4_P.HILInitialize_EIPEnter
	  section.data(25).logicalSrcIdx = 101;
	  section.data(25).dtTransOffset = 24;
	
	  ;% helicopter_exercise4_P.HILInitialize_EIStart
	  section.data(26).logicalSrcIdx = 102;
	  section.data(26).dtTransOffset = 25;
	
	  ;% helicopter_exercise4_P.HILInitialize_EIEnter
	  section.data(27).logicalSrcIdx = 103;
	  section.data(27).dtTransOffset = 26;
	
	  ;% helicopter_exercise4_P.HILInitialize_POPStart
	  section.data(28).logicalSrcIdx = 104;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helicopter_exercise4_P.HILInitialize_POPEnter
	  section.data(29).logicalSrcIdx = 105;
	  section.data(29).dtTransOffset = 28;
	
	  ;% helicopter_exercise4_P.HILInitialize_POStart
	  section.data(30).logicalSrcIdx = 106;
	  section.data(30).dtTransOffset = 29;
	
	  ;% helicopter_exercise4_P.HILInitialize_POEnter
	  section.data(31).logicalSrcIdx = 107;
	  section.data(31).dtTransOffset = 30;
	
	  ;% helicopter_exercise4_P.HILInitialize_POReset
	  section.data(32).logicalSrcIdx = 108;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helicopter_exercise4_P.HILInitialize_OOReset
	  section.data(33).logicalSrcIdx = 109;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOFinal
	  section.data(34).logicalSrcIdx = 110;
	  section.data(34).dtTransOffset = 33;
	
	  ;% helicopter_exercise4_P.HILInitialize_DOInitial
	  section.data(35).logicalSrcIdx = 111;
	  section.data(35).dtTransOffset = 34;
	
	  ;% helicopter_exercise4_P.HILReadEncoderTimebase_Active
	  section.data(36).logicalSrcIdx = 112;
	  section.data(36).dtTransOffset = 35;
	
	  ;% helicopter_exercise4_P.HILWriteAnalog_Active
	  ...
	  ;% helicopter_exercise4_P.HILReadEncoderTimebase_Overflow
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (helicopter_exercise4_B)
    ;%
      section.nData     = 20;
      section.data(20)  = dumData; %prealloc
      
	  ;% helicopter_exercise4_B.Gain1
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% helicopter_exercise4_B.Gain1_e
	  ...
	  ;% helicopter_exercise4_B.TmpSignalConversionAtToFileInpo
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 20;
	
	  ;% helicopter_exercise4_B.Gain_l
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (helicopter_exercise4_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% helicopter_exercise4_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% helicopter_exercise4_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_exercise4_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% helicopter_exercise4_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% helicopter_exercise4_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% helicopter_exercise4_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% helicopter_exercise4_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 56;
	
	  ;% helicopter_exercise4_DW.TimeStampA
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 64;
	
	  ;% helicopter_exercise4_DW.LastUAtTimeA
	  section.data(10).logicalSrcIdx = 9;
	  ...
	  ;% helicopter_exercise4_DW.LastUAtTimeB
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 67;
	
	  ;% helicopter_exercise4_DW.HILWriteAnalog_Buffer
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% helicopter_exercise4_DW.u_k_PWORK.TimePtr
	  ...
	  ;% helicopter_exercise4_DW.Scope_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_exercise4_DW.Scope1_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_exercise4_DW.ToFile_PWORK.FilePtr
	  section.data(5).logicalSrcIdx = 19;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_exercise4_DW.ElevationScopedegs_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 20;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_exercise4_DW.ElevationScopedeg_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 21;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_exercise4_DW.PitchScopedeg_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 22;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_exercise4_DW.PtichrateScopedegs_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 23;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_exercise4_DW.PtichrateScopedegs1_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 24;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_exercise4_DW.TravelrateScopedegs_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 25;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_exercise4_DW.TravelScopedeg_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_exercise4_DW.Backmotor_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_exercise4_DW.Frontmotor_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 28;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_exercise4_DW.HILWriteAnalog_PWORK
	  ...
	  ;% helicopter_exercise4_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 30;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 31;
	  section.data(2).dtTransOffset = 3;
	
	  ;% helicopter_exercise4_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 32;
	  section.data(3).dtTransOffset = 11;
	
	  ;% helicopter_exercise4_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 33;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_exercise4_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 34;
	  section.data(5).dtTransOffset = 27;
	
	  ;% helicopter_exercise4_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 35;
	  section.data(6).dtTransOffset = 35;
	
	  ;% helicopter_exercise4_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% helicopter_exercise4_DW.HILInitialize_POSortedChans
	  ...
	  ;% helicopter_exercise4_DW.u_k_IWORK.PrevIndex
	  section.data(1).logicalSrcIdx = 38;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_exercise4_DW.FromWorkspace1_IWORK.PrevIndex
	  ...
	  ;% helicopter_exercise4_DW.If_ActiveSubsystem
  ...
  targMap.checksum0 = 1317430043;
  targMap.checksum1 = 2379873441;
  targMap.checksum2 = 2375125675;
  targMap.checksum3 = 2049113307;
