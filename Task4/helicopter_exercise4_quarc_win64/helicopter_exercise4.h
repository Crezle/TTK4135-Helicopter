...
#ifndef RTW_HEADER_helicopter_exercise4_h_
#define RTW_HEADER_helicopter_exercise4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_exercise4_COMMON_INCLUDES_
#define helicopter_exercise4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                               /* helicopter_exercise4_COMMON_INCLUDES_ */

#include "helicopter_exercise4_types.h"
...
#define helicopter_exercise4_rtModel   RT_MODEL_helicopter_exercise4_T
...
#define rtB                            helicopter_exercise4_B
#define BlockIO                        B_helicopter_exercise4_T
#define rtX                            helicopter_exercise4_X
#define ContinuousStates               X_helicopter_exercise4_T
#define rtXdot                         helicopter_exercise4_XDot
#define StateDerivatives               XDot_helicopter_exercise4_T
#define tXdis                          helicopter_exercise4_XDis
#define StateDisabled                  XDis_helicopter_exercise4_T
#define rtP                            helicopter_exercise4_P
#define Parameters                     P_helicopter_exercise4_T
#define rtDWork                        helicopter_exercise4_DW
#define D_Work                         DW_helicopter_exercise4_T

/* Parameters (default storage) */
struct P_helicopter_exercise4_T_ {
...
struct tag_RTM_helicopter_exercise4_T {
  const char_T *path;
...
extern P_helicopter_exercise4_T helicopter_exercise4_P;

/* Block signals (default storage) */
extern B_helicopter_exercise4_T helicopter_exercise4_B;

/* Continuous states (default storage) */
extern X_helicopter_exercise4_T helicopter_exercise4_X;

/* Block states (default storage) */
extern DW_helicopter_exercise4_T helicopter_exercise4_DW;

/* Model entry point functions */
extern void helicopter_exercise4_initialize(void);
extern void helicopter_exercise4_output(void);
extern void helicopter_exercise4_update(void);
extern void helicopter_exercise4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_exercise4_rtModel *helicopter_exercise4(void);
...
extern RT_MODEL_helicopter_exercise4_T *const helicopter_exercise4_M;
 ...
 *
 * '<Root>' : 'helicopter_exercise4'
 * '<S1>'   : 'helicopter_exercise4/Conversion'
 * '<S2>'   : 'helicopter_exercise4/Degrees to Radians'
 * '<S3>'   : 'helicopter_exercise4/Degrees to Radians1'
 * '<S4>'   : 'helicopter_exercise4/Elevation controller'
 * '<S5>'   : 'helicopter_exercise4/Helicopter_interface'
 * '<S6>'   : 'helicopter_exercise4/Pitch controller'
 * '<S7>'   : 'helicopter_exercise4/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopter_exercise4/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_exercise4/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_exercise4/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_exercise4/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_exercise4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_exercise4/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_exercise4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_exercise4_h_ */
