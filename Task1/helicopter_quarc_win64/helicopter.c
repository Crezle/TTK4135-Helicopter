...
void helicopter_output(void)
{
   ...
   *  Gain: '<S2>/Gain1'
   */
  rtb_Derivative = helicopter_P.elevation_ref_Value - helicopter_P.Gain1_Gain_f *
    helicopter_B.Sum;
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (1402012006U);
  helicopter_M->Sizes.checksums[1] = (545479244U);
  helicopter_M->Sizes.checksums[2] = (310840664U);
  helicopter_M->Sizes.checksums[3] = (3161345623U);
